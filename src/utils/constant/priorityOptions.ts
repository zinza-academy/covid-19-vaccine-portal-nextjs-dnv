const priorityOptions = [
  ...
  {
    value: 2,
    label: 'Lực lượng Quân đội'
  },
  {
    value: 3,
    label: 'Lực lượng Công an'
  },
  {
    value: 4,
    label:
  ...
  {
    value: 5,
    label: 'Hải quan, cán bộ làm công tác xuất nhập cảnh'
  },
  {
    value: 6,
    label:
  ...
  {
    value: 8,
    label: 'Người mắc các bệnh mạn tính; Người trên 65 tuổi'
  },
  {
    value: 9,
    label: 'Người sinh sống tại các vùng có dịch'
  },
  {
    value: 10,
    label: 'Người nghèo, các đối tượng chính sách xã hội'
  },
  {
    value: 11,
    label:
  ...
  {
    value: 13,
    label: 'Các chức sắc, chức việc các tôn giáo'
  },
  {
    value: 14,
    label: 'Người lao động tự do'
  },
  {
    value: 15,
    label:
